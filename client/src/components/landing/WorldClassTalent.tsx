        ...
        <section className="bg-white py-24">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <p className="mt-6 text-lg text-gray-600 font-medium opacity-90">
                ...
                {/* Services Grid with Custom Border Logic */}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                        {services.map((service, index) => (
                            <motion.div
                                ...
                                className={`p-10 border-b border-gray-100 group transition-all duration-300 relative cursor-pointer
                                    ${service.highlight ? 'bg-[#2563eb] text-white' : 'bg-white hover:bg-[#2563eb] hover:text-white'}
                            ...
                            >
                                <div className="flex flex-col sm:flex-row items-start gap-6">
                                    <div className={`p-2.5 rounded-lg shrink-0 transition-colors duration-300 ${service.highlight ? 'bg-white/10' : 'bg-transparent border border-blue-100 group-hover:bg-white/10 group-hover:border-transparent'}`}>
                                        <service.icon className={`w-10 h-10 transition-colors duration-300 ${service.highlight ? 'text-white' : 'text-blue-500 group-hover:text-white'}`} strokeWidth={1} />
                                    </div>
                                    <div className="flex-1">
                                        <div className="flex items-center justify-between mb-3">
                                            <h3 className={`text-xl font-bold tracking-tight transition-colors duration-300 ${service.highlight ? 'text-white' : 'text-gray-900 group-hover:text-white'}`}>
                                                {service.title}
                                            </h3>
                        ...
                        {/* More Skills Card */}
                        <div className="p-10 lg:col-span-2 md:col-span-1 bg-gray-50/30 flex items-center">
                            <div>
