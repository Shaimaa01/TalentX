        ...
        <main className="min-h-screen bg-white">
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div className="max-w-xl">
                            ...
                            <p className="mt-8 text-lg text-gray-600 leading-relaxed">
                                Accelerate your growth with world-class marketing strategists, SEO
                                experts, and growth hackers. TalentX provides the marketing muscle
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-bold text-[#1a1a2e]">
                            Marketing Expertise for Every Goal
                        </h2>
                        <p className="mt-4 text-gray-600">
                            Hire specialists across the entire marketing funnel.
                        </p>
                    </div>
            ...
            <section className="py-24 bg-[#f8faff]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-bold text-[#1a1a2e]">
                            Why Top Companies Choose TalentX Marketers
                        </h2>
                    </div>
                        ...
                        {[
                            {
                                ...
                                desc: 'Our experts focus on measurable results and sustainable growth through rigorous testing and optimization.',
                            },
                            {
                                icon: Zap,
                                title: 'Strategic Impact',
                                desc: 'Beyond execution, our marketers bring high-level strategy to help you find and dominate your market.',
                            },
                            {
                                icon: Shield,
                                title: 'Industry Depth',
                                desc: 'Work with specialists who have deep experience in your specific vertical, from SaaS to Consumer Brands.',
                            },
                        ].map((benefit, idx) => (
            ...
            <section className="py-16 border-t border-gray-100 bg-white">
                <div className="flex flex-col sm:flex-row items-center justify-center gap-8 px-4">
                    <span className="text-lg text-gray-900 font-medium">
                        Top Marketing Experts are in high demand.
                    </span>
                    <Link href={createPageUrl('Pricing')}>
